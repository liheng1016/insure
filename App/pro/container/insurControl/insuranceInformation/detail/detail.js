		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(LiComponent, { lableName: "投保日期 : ",
					content: (0, _function.getFormatData)(detail.insure_date) }),
				_react2.default.createElement(LiComponent, { lableName: "保险期限 : ",
					content: (0, _function.getFormatData)(detail.start_date) + "~" + (0, _function.getFormatData)(detail.done_at) }),
				_react2.default.createElement(
					"div",
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(LiComponent, { lableName: "出险时间 : ",
					content: (0, _function.getFormatData)(claim.accident_at) }),
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					(0, _function.getFormatData)(auditing.approval_at) + " " + (0, _function.getHoursMinutes)(auditing.approval_at)
				),
				_react2.default.createElement(
					"div",
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					(0, _function.getFormatData)(auditing.apply_at) + " " + (0, _function.getHoursMinutes)(auditing.apply_at)
				),
				_react2.default.createElement(
					"div",
					{ className: _detail2.default["main"] },
