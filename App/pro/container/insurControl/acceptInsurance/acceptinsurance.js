	...
	_createClass(AcceptInsurance, [{
		...
		value: function dealExportData() {
			...
			exportdata.map(function (item, index) {
				content.push([item['apply_number'], item['apply_company_name'], item['company_name'], item['insurance_number'], item['grid_name'], item['type_name'], status[item['status']], item['insurance_company'], item['start_date'] ? (0, _function.getFormatData)(item['start_date']) : "", item['done_at'] ? (0, _function.getFormatData)(item['done_at']) : ""]);
			});
		...
		value: function getTrContentList() {
			...
			return lists.map(function (l, key) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"td",
						{ title: l.start_date ? (0, _function.getFormatData)(l.start_date) : "" },
						l.start_date ? (0, _function.getFormatData)(l.start_date) : ""
					),
					_react2.default.createElement(
						"td",
						{ title: l.done_at ? (0, _function.getFormatData)(l.done_at) : "" },
						l.done_at ? (0, _function.getFormatData)(l.done_at) : ""
					)
				);
			});
		}
