		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					LiContent,
					{ LabelName: '投保日期' },
					_react2.default.createElement(_datePicker2.default, { inputCss: DateStyle, defaultValue: (0, _function.getFormatData)(security.insure_date), disabled: true })
				),
				_react2.default.createElement(
					LiContent,
					{ LabelName: '保险期限' },
					_react2.default.createElement(_datePicker2.default, { inputCss: CoverStyle, defaultValue: (0, _function.getFormatData)(security.start_date), disabled: true }),
					_react2.default.createElement(
						"span",
						{ className: _index2.default["separator"] },
						"~"
					),
					_react2.default.createElement(_datePicker2.default, { inputCss: CoverStyle, defaultValue: (0, _function.getFormatData)(security.done_at), disabled: true })
				)
			);
		}
	}]);
...
var InformantInformationContent = exports.InformantInformationContent = function (_Component10) {
	...
	_createClass(InformantInformationContent, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_input2.default, { ref: "phone", defaultValue: this.props.phone, styleCss: InputStyle })
				),
				_react2.default.createElement(
					LiMustContent,
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_datePicker2.default, { ref: "report_at", defaultValue: (0, _function.getFormatData)(this.props.report_at), inputCss: CoverStyle })
				),
				_react2.default.createElement(
					LiContent,
					{ LabelName: '现场联系人' },
				...
				_react2.default.createElement(
					LiContent,
					{ LabelName: '现场联系方式' },
					_react2.default.createElement(_input2.default, { ref: "contacts_phone", styleCss: InputStyle, defaultValue: this.props.contacts_phone })
				)
			);
		}
	}, {
		...
		value: function getValue() {
			...
			isVerify = !!result["user_name"] && !!result["phone"] && !!result["report_at"];
			return _extends({
				infoVerify: isVerify
			}, result);
		}
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_select2.default, { ref: "status", styleCss: InputStyle, defaultValue: this.props.status, options: status })
				),
				_react2.default.createElement(
					LiMustContent,
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_datePicker2.default, { ref: "compensate_at", defaultValue: (0, _function.getFormatData)(this.props.compensate_at), inputCss: CoverStyle })
				)
			);
		}
	}, {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_datePicker2.default, {
						ref: "accident_at",
						inputCss: DateStyle,
						defaultValue: this.props.accident_at })
				),
				_react2.default.createElement(
					LiContent,
					{ LabelName: '事故类型' },
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_datePicker2.default, {
						ref: "comp_at",
						inputCss: DateStyle,
						defaultValue: (0, _function.getFormatData)(this.props.comp_at) })
				)
			);
		}
	}, {
