...
export default class Pagination extends Component {
    ...
    render() {
        let {position="left",isBottom="false"} = this.props;
        ...
        return (
            <div className={style['pagination']} style={{float:position}}>
...
export class PaginationBox extends Component{
    render() {
        return (
            <div className={style["bottom-pagination"]}>
                {this.props.children}
            </div>
        );
    }
