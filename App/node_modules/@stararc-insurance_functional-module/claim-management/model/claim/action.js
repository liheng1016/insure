...
var claimAction = {
	...
	create: function create() {
		...
		return (0, _reduxBuildTools.requestHandle)(_actiontype2.default.CREATE, _request2.default.create, params);
	},
	update: function update() {
		var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

		return (0, _reduxBuildTools.requestHandle)(_actiontype2.default.UPDATE, _request2.default.update, params);
	},
	...
	get_accident_types: function get_accident_types() {
		...
		return (0, _reduxBuildTools.requestHandle)(_actiontype2.default.GET_ACCIDENT_TYPES, _request2.default.get_accident_types, params);
	},
	// 理赔的创建附件上传
	upload_claim: function upload_claim() {
		...
		return (0, _reduxBuildTools.requestHandle)(_actiontype2.default.UPLOAD_CLAIM, _request2.default.upload_claim, params, type);
	},
	...
	//清除详情数据
	unmout_claim_detail: function unmout_claim_detail() {
		var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

		return function (dispatch) {
			return dispatch({
				type: _actiontype2.default.UNMOUT_CLAIM_DETAIL.RECEIVE_DATA,
				msg: "卸载附件里面包含的数据"
			});
		};
	}
