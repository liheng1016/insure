		...
		value: function getTrContent() {
			...
			return list.map(function (l, key) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						_table.TableTd,
						{ text: (0, _helpTools.getFormatData)(l.insure_date, "-") },
						(0, _helpTools.getFormatData)(l.insure_date, "-")
					),
					_react2.default.createElement(
						_table.TableTd,
						{ text: (0, _helpTools.getFormatData)(l.done_at, "-") },
						(0, _helpTools.getFormatData)(l.done_at, "-")
					),
					_react2.default.createElement(
						_table.TableTd,
						{ text: l.insure_money },
