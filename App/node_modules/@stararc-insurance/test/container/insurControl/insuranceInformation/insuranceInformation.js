		...
		value: function getTrContent() {
			...
			return doneList.map(function (l, key) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"td",
						{ title: (0, _function.getFormatData)(l.apply_at) + " " + (0, _function.getHoursMinutes)(l.apply_at) },
						(0, _function.getFormatData)(l.apply_at) + " " + (0, _function.getHoursMinutes)(l.apply_at)
					)
				);
			});
		}
		...
		value: function getTrContent() {
			...
			return lists.map(function (l, key) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"td",
						{ title: l.done_at ? (0, _function.getFormatData)(l.done_at) + " " + (0, _function.getHoursMinutes)(l.done_at) : "" },
						l.done_at ? (0, _function.getFormatData)(l.done_at) + " " + (0, _function.getHoursMinutes)(l.done_at) : ""
					)
				);
			});
		}
