...
var riskwarningAction = {
	...
	add: function add() {
		...
		return (0, _actionHandle.requestHandle)(_actiontype2.default.ADD, _request2.default.add, params);
	},
	...
	verify_password: function verify_password() {
		...
		return (0, _actionHandle.requestHandle)(_actiontype2.default.VERIFY_PASSWORD, _request2.default.verify_password, params);
	},
	delete: function _delete() {
		...
		return (0, _actionHandle.actionHandle)(_actiontype2.default.DELETE, _request2.default.delete, params, onSuccess, onFail);
	},
	// 附件
