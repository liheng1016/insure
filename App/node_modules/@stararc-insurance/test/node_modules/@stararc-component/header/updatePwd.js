...
var UpdatePwd = function (_Component) {
    ...
    _createClass(UpdatePwd, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement('div', { className: _updatePwd2.default["alert__wrap_password"] }, _react2.default.createElement('div', { className: _updatePwd2.default["alert__bg_password"], onClick: function onClick(e) {
                    return _this2.closeAlertPassword(e);
                } }), _react2.default.createElement('div', { className: _updatePwd2.default["alert__password"] }, _react2.default.createElement('div', { className: _updatePwd2.default["alert_user_update"] }, _react2.default.createElement('lable', { className: _updatePwd2.default["alert_user_lable"] }, _react2.default.createElement('span', { className: _updatePwd2.default["required_mark"] }, '*'), "\u539F\u59CB\u5BC6\u7801\uFF1A"), _react2.default.createElement('div', { className: _updatePwd2.default["alert_user_input"] }, _react2.default.createElement(_index2.default, { ref: 'password', type: "password", onChange: function onChange(e) {
                    return _this2.changePassword(e);
                } })), _react2.default.createElement('span', { className: _updatePwd2.default[this.state.passwordEerror] })), _react2.default.createElement('div', { className: _updatePwd2.default["alert_user_update"] }, _react2.default.createElement('lable', { className: _updatePwd2.default["alert_user_lable"] }, _react2.default.createElement('span', { className: _updatePwd2.default["required_mark"] }, '*'), "\u65B0\u5BC6\u7801\uFF1A"), _react2.default.createElement('div', { className: _updatePwd2.default["alert_user_input"] }, _react2.default.createElement(_index2.default, { ref: 'newPassword', type: "password", onChange: function onChange(e) {
                    return _this2.changeNewPassword(e);
                } })), _react2.default.createElement('span', { className: _updatePwd2.default[this.state.newPasswordEerror] })), _react2.default.createElement('div', { className: _updatePwd2.default["alert_user_update"] }, _react2.default.createElement('lable', { className: _updatePwd2.default["alert_user_lable"] }, _react2.default.createElement('span', { className: _updatePwd2.default["required_mark"] }, '*'), "\u786E\u8BA4\u65B0\u5BC6\u7801\uFF1A"), _react2.default.createElement('div', { className: _updatePwd2.default["alert_user_input"] }, _react2.default.createElement(_index2.default, { ref: 'newConfirmPassword', type: "password", onChange: function onChange(e) {
                    return _this2.changeNewConfirmPassword(e);
                } })), _react2.default.createElement('span', { className: _updatePwd2.default[this.state.newConfirmPasswordEerror] })), _react2.default.createElement('div', { className: _updatePwd2.default["alert_user_submit"] }, _react2.default.createElement(_index4.default, { text: "提交", onClick: function onClick(e) {
