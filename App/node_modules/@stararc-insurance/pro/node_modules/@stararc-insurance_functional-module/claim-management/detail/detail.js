		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ styleCss: { height: 50 } },
					_react2.default.createElement(ActionBar, _extends({}, this.props, { actionbar: this.props.detail }))
				),
				_react2.default.createElement(
	...
	_createClass(ActionBar, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				actionbar.status == "2" || actionbar.status == "1" ? _react2.default.createElement(_button2.default, {
					onClick: function onClick(e) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(LiComponent, { lableName: '报案时间 : ',
					content: (0, _helpTools.getFormatData)(informant.report_at) }),
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(LiComponent, { lableName: '受理时间 : ',
					content: (0, _helpTools.getFormatData)(caseacceptance.compensate_at) })
			);
		}
	}]);
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(LiComponent, { lableName: '赔付时间 : ',
					content: (0, _helpTools.getFormatData)(payment.comp_at) })
			);
		}
	}]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		...
		unmout_claim_detail: function unmout_claim_detail(obj) {
			dispatch(_action2.default.unmout_claim_detail(obj));
		}
	};
};
