...
var Risk = function (_Component4) {
    ...
    function Risk(props) {
        ...
        _this6.state = {
            Y: false,
            N: false,
            since_at: (0, _helpTools.getFormatDay)(new Date(), 'm')
        };
        return _this6;
    }
    ...
    _createClass(Risk, [{
        ...
        value: function getOptions() {
            return {
                since_at: (0, _helpTools.getFirstAndLastDay)(this.refs.since_at.state.value).since_at ? (0, _helpTools.getFirstAndLastDay)(this.refs.since_at.state.value).since_at : (0, _helpTools.getFormatDay)(new Date(), 'f'),
                max_at: (0, _helpTools.getFirstAndLastDay)(this.refs.since_at.state.value).max_at ? (0, _helpTools.getFirstAndLastDay)(this.refs.since_at.state.value).max_at : (0, _helpTools.getFormatDay)(new Date(), 'l')
            };
        }
    }, {
        key: 'submitFom',
        ...
        value: function getDataList() {
            ...
            var renkingString = renkingList.map(function (item, index) {
                return _react2.default.createElement(
                    ...
                    index + 1,
                    (0, _helpTools.limitLen)(item.company_name, 8),
                    _react2.default.createElement(
                        'span',
                        null,
                        item.score_num
