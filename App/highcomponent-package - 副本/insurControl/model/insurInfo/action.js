...
var insurInfoAction = {
	...
	create_insur: function create_insur() {
		...
		return (0, _reduxBuildTools.requestHandle)(_actiontype2.default.CREATE_INSUR, _request2.default.create_insur, params);
	},
	// 承保保单的编辑
	update_insur: function update_insur() {
		var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

		return (0, _reduxBuildTools.requestHandle)(_actiontype2.default.UPDATE_INSUR, _request2.default.update_insur, params);
	},
	// 网格列表
	grid_list: function grid_list() {
		var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

		return (0, _reduxBuildTools.requestHandle)(_actiontype2.default.GRID_LIST, _request2.default.grid_list, params);
	},
	// 企业行业类型
	industry_list: function industry_list() {
		var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

		return (0, _reduxBuildTools.requestHandle)(_actiontype2.default.INDUSTRY_LIST, _request2.default.industry_list, params);
	},
	// 获取企业列表
	company_list: function company_list() {
		var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

		return (0, _reduxBuildTools.requestHandle)(_actiontype2.default.COMPANY_LIST, _request2.default.company_list, params);
	},
	// 承保公司
	get_accept_company: function get_accept_company() {
		var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

		return (0, _reduxBuildTools.requestHandle)(_actiontype2.default.GET_ACCEPT_COMPANY, _request2.default.get_accept_company, params);
	},
	// 投保单号
	get_apply_number: function get_apply_number() {
		var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

		return (0, _reduxBuildTools.requestHandle)(_actiontype2.default.GET_APPLY_NUMBER, _request2.default.get_apply_number, params);
	},
	// 保险产品列表
	get_insur_product: function get_insur_product() {
		var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

		return (0, _reduxBuildTools.requestHandle)(_actiontype2.default.GET_INSUR_PRODUCT, _request2.default.get_insur_product, params);
	},
	// 承保保单的附件上传
