...
let mapStateToProps = (state) => {
    return {
    	companyList:state.acceptInsurReducer.companyList,
    	companyCondition:state.acceptInsurReducer.companyCondition,
    	acceptCompany:state.acceptInsurReducer.acceptCompany,
    	applyNumber:state.acceptInsurReducer.applyNumber,
    	insurProductList:state.acceptInsurReducer.insurProductList,
    	insureAcctach:state.acceptInsurReducer.insureAcctach,
