				...
				<ul className={style["content"]}>
					<LiUpLoad LabelName={'营业执照 '} 
						...
						<span className={style["attach--display"]}>
							<a href={insureAcctach.business.attachment_path}>{insureAcctach.business.name}</a>
						</span>
					</LiUpLoad>
					<LiUpLoad LabelName={'全员投保证明 '} 
						LabelContent={'请上传pdf、jpg、jpeg、png格式附件'}>
						<span className={style["attach--display"]}>
							<a href={insureAcctach.full.attachment_path}>{insureAcctach.full.name}</a>
						</span>
						<UploadFile 
							accept={".jpg, .jpeg,.png,.pdf"}
							uploadHandle={this.props.uploadHandle} 
					...
					<LiUpLoad LabelName={'社保征缴通知单 '} 
						LabelContent={'请上传pdf、jpg、jpeg、png格式附件'}>
						<span className={style["attach--display"]}>
							<a href={insureAcctach.social.attachment_path}>{insureAcctach.social.name}</a>
						</span>
						<UploadFile 
							accept={".jpg, .jpeg,.png,.pdf"}
							uploadHandle={this.props.uploadHandle} 
					...
					<LiUpLoad LabelName={'投保单盖章上传 '} 
						LabelContent={'请上传pdf、jpg、jpeg、png格式附件'}>
						<span className={style["attach--display"]}>
							<a href={insureAcctach.seal.attachment_path}>{insureAcctach.seal.name}</a>
						</span>
						<UploadFile
							accept={".jpg, .jpeg,.png,.pdf"}
							uploadHandle={this.props.uploadHandle} 
					...
					<LiUpLoad LabelName={'人员清单 '} 
						...
						<span className={style["attach--display"]}>
							<a href={insureAcctach.people.attachment_path}>{insureAcctach.people.name}</a>
						</span>
						<UploadFile 
					...
					<LiUpLoad LabelName={'其他 '} 
						...
						<span className={style["attach--display"]}>
							<a href={insureAcctach.other.attachment_path}>{insureAcctach.other.name}</a>
						</span>
						<UploadFile 
			...
			<div className={style["applicant-wrap"]}>
				...
				<div className={style["content"]}>
					...
					<span className={style["article--content"]}>
						<a href={articleContent.attachment_path}>{articleContent.name}</a>
					</span>					
				</div>
			</div>
		);
